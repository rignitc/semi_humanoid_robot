...
echo_and_run cd "/home/nvidia/rigguv2/catkin_ws/src/rosserial/rosserial_python"
...
echo_and_run /usr/bin/env \
    ...
    build --build-base "/home/nvidia/rigguv2/catkin_ws/build/rosserial/rosserial_python" \
    install \
    $DESTDIR_ARG \
