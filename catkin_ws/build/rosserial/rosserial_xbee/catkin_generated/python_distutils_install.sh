...
echo_and_run cd "/home/nvidia/rigguv2/catkin_ws/src/rosserial/rosserial_xbee"
...
echo_and_run /usr/bin/env \
    ...
    build --build-base "/home/nvidia/rigguv2/catkin_ws/build/rosserial/rosserial_xbee" \
    install \
    $DESTDIR_ARG \
