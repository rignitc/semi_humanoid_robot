...
echo_and_run cd "/home/nvidia/rigguv2/catkin_ws/src/rosserial/rosserial_vex_cortex"
...
echo_and_run /usr/bin/env \
    ...
    build --build-base "/home/nvidia/rigguv2/catkin_ws/build/rosserial/rosserial_vex_cortex" \
    install \
    $DESTDIR_ARG \
